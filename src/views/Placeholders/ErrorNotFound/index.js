...
function ErrorNotFound(props){
    ...
    return(
        <div className='error-page placeholder not-found'>
            <img  width="250px" src='/img/placeholders/notFound.svg' alt='404 Page Not Found' className='error-image' />
            <Typography variant="h5" gutterBottom className='error-text'>
                <Trans>placeholder.cannotFindPage</Trans>
            </Typography>
            <Link to="/" color="primary" variant="contained" component={Button} className="error-button">
