...
function Sidebar(props) {
    const { handleDrawerCloseOnHover, handleDrawerOpenOnHover, handleDrawerOpenOnClick, handleDrawerCloseOnClick } = props
    const themeContext = useContext(ThemeContext);
    const matches = useMediaQuery('(max-width:' + config.mobileScreenWidth + ')');
    const classes = useStyles({ matches, sidebarOpenedEvent: themeContext.sidebarOpenedEvent });
